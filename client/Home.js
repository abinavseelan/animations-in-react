...
const Home = () => (
    <div className="container">
        <div>
            ...
            <Link to="/final/demo-3">Demo 4 - Shared Element Transition</Link>
            <Link to="/final/demo-4">Demo 5 - Animated Menu</Link>

            <h1>Live Code!</h1>
            <Link to="/live/demo-2">Dismissible cards with {'<Motion />'}</Link>
            <Link to="/live/demo-3">Shared Element Transition</Link>
        </div>
    </div>
);
